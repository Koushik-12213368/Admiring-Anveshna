(function () {
  ...
  function openDailyPopup(state, forceDayKey) {
    ...
    var dayMusicIds = { rose: 'rose-popup-music', propose: 'propose-popup-music', chocolate: 'chocolate-popup-music', teddy: 'teddy-popup-music', promise: 'promise-popup-music', hug: 'hug-popup-music' };
  ...
  function closeDailyPopup() {
    ...
    ['rose-popup-music', 'propose-popup-music', 'chocolate-popup-music', 'teddy-popup-music', 'promise-popup-music', 'hug-popup-music'].forEach(function (id) {
